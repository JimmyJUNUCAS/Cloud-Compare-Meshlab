...
public:
	...
	PlanePrimitiveShape(const RANSAC::Plane &plane);
	size_t Identifier() const;
	unsigned int RequiredSamples() const { return RANSAC::Plane::RequiredSamples; }
	...
	const RANSAC::Plane &Internal() const { return m_plane; }
...
{
public:
	PlaneLevMarFunc(const RANSAC::Plane &plane)
	{
