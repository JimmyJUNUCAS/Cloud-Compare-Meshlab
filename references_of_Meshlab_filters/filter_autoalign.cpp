   ...
   switch(ID(action))	 {
    case FP_ALIGN_4PCS :
     ...
     break;
       ...
       parlst.addParam(new RichInt("sampleSize",2000,"Sample Size", "The size of the uniform grid that is used for searching the best translation for a given rotation"));
       parlst.addParam(new RichInt("gridSize",500,"Grid Size", "The size of the uniform grid that is used for searching the best translation for a given rotation"));
       parlst.addParam(new RichInt("RotationNumber",2000,"Rotation Number", "sss"));
       break;
